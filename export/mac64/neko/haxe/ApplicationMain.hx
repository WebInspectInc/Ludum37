...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Ludum37", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Ludum37";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Ludum37", null, { width: 640, height: 480 });
